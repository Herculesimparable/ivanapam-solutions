  ...
  const STRINGS = {
    pt: {
      ...
      booking: {
        ...
        selectFirst: "Selecione um ou mais serviços para continuar a reserva.",
    ...
    en: {
      ...
      booking: {
        ...
        selectFirst: "Select one or more services to continue your booking.",
    ...
    es: {
      ...
      booking: {
        ...
        selectFirst: "Selecciona uno o más servicios para continuar la reserva.",
        pageTitle: "Reservar — IVANAPAM Solutions",
        back: "Inicio",
    ...
    fr: {
      ...
      booking: {
        ...
        selectFirst: "Sélectionnez un ou plusieurs services pour continuer la réservation.",
